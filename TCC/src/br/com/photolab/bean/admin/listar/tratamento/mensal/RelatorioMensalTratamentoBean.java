package br.com.photolab.bean.admin.listar.tratamento.mensal;
...
public class RelatorioMensalTratamentoBean
{
    ...
    public LineChartModel createLineModels() throws Exception {
        ...
        lineModel1.setTitle("Produção Tratamento do mês: " + usuarioBean.getMesSelecionado().getNome()+" de "+ usuarioBean.getAnoSelecionado());
