package br.com.photolab.bean.usuarios.usuario.tratamento;
...
@ManagedBean
@ViewScoped
public class RelatorioTratamentoUsuarioBean
{
    ...
    public RelatorioTratamentoUsuarioBean()  {
        try {
            data = new Date();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public LineChartModel createLineModels() throws Exception {
        ...
        lineModel1= initCategoryModel(usuarioDao.ListarUsersTratamento());
